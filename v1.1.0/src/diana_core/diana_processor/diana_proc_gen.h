...
// FPU
#define GET_REG_FPU_ST0(Y) DianaProcessor_FPU_GetValueEx(pCallContext, DianaProcessor_FPU_QueryReg(pCallContext, reg_fpu_ST0), (Y))
#define SET_REG_FPU_ST0(Y) DianaProcessor_FPU_SetValueEx(pCallContext, DianaProcessor_FPU_QueryReg(pCallContext, reg_fpu_ST0), (Y))
#define GET_REG_FPU_ST1(Y) DianaProcessor_FPU_GetValueEx(pCallContext, DianaProcessor_FPU_QueryReg(pCallContext, reg_fpu_ST1), (Y))
#define SET_REG_FPU_ST1(Y) DianaProcessor_FPU_SetValueEx(pCallContext, DianaProcessor_FPU_QueryReg(pCallContext, reg_fpu_ST1), (Y))
#define GET_REG_FPU_ST2(Y) DianaProcessor_FPU_GetValueEx(pCallContext, DianaProcessor_FPU_QueryReg(pCallContext, reg_fpu_ST2), (Y))
#define SET_REG_FPU_ST2(Y) DianaProcessor_FPU_SetValueEx(pCallContext, DianaProcessor_FPU_QueryReg(pCallContext, reg_fpu_ST2), (Y))
#define GET_REG_FPU_ST3(Y) DianaProcessor_FPU_GetValueEx(pCallContext, DianaProcessor_FPU_QueryReg(pCallContext, reg_fpu_ST3), (Y))
#define SET_REG_FPU_ST3(Y) DianaProcessor_FPU_SetValueEx(pCallContext, DianaProcessor_FPU_QueryReg(pCallContext, reg_fpu_ST3), (Y))
#define GET_REG_FPU_ST4(Y) DianaProcessor_FPU_GetValueEx(pCallContext, DianaProcessor_FPU_QueryReg(pCallContext, reg_fpu_ST4), (Y))
#define SET_REG_FPU_ST4(Y) DianaProcessor_FPU_SetValueEx(pCallContext, DianaProcessor_FPU_QueryReg(pCallContext, reg_fpu_ST4), (Y))
#define GET_REG_FPU_ST5(Y) DianaProcessor_FPU_GetValueEx(pCallContext, DianaProcessor_FPU_QueryReg(pCallContext, reg_fpu_ST5), (Y))
#define SET_REG_FPU_ST5(Y) DianaProcessor_FPU_SetValueEx(pCallContext, DianaProcessor_FPU_QueryReg(pCallContext, reg_fpu_ST5), (Y))
#define GET_REG_FPU_ST6(Y) DianaProcessor_FPU_GetValueEx(pCallContext, DianaProcessor_FPU_QueryReg(pCallContext, reg_fpu_ST6), (Y))
#define SET_REG_FPU_ST6(Y) DianaProcessor_FPU_SetValueEx(pCallContext, DianaProcessor_FPU_QueryReg(pCallContext, reg_fpu_ST6), (Y))
#define GET_REG_FPU_ST7(Y) DianaProcessor_FPU_GetValueEx(pCallContext, DianaProcessor_FPU_QueryReg(pCallContext, reg_fpu_ST7), (Y))
#define SET_REG_FPU_ST7(Y) DianaProcessor_FPU_SetValueEx(pCallContext, DianaProcessor_FPU_QueryReg(pCallContext, reg_fpu_ST7), (Y))
