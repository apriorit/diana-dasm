...
static float64 propagateFloat64MulAddNaN(float64 a, float64 b, float64 c, float_status_t *status)
{
    ...
    a |= DI_CONST64(0x0008000000000000);
    b |= DI_CONST64(0x0008000000000000);
    c |= DI_CONST64(0x0008000000000000);
...
float32 float32_muladd(float32 a, float32 b, float32 c, int flags, float_status_t *status)
{
    ...
    DI_INT16 aExp, bExp, cExp, pExp, zExp;
    DI_UINT32 aSig, bSig, cSig;
    int pInf, pZero, pSign;
    DI_UINT64 pSig64, cSig64, zSig64;
    DI_UINT32 pSig;
    int shiftcount;
    int infzero;
    int expDiff;
    ...
    pSig64 = (DI_UINT64)aSig * bSig;
    if ((DI_INT64)(pSig64 << 1) >= 0) {
        pSig64 <<= 1;
        pExp--;
    }
    ...
    if (cExp == 0) {
        if (!cSig) {
            ...
            pSig = (DI_UINT32) shift64RightJamming(pSig64, 32);
    ...
    cSig64 = (DI_UINT64)cSig << 39;
    cSig64 |= DI_CONST64(0x4000000000000000);
    expDiff = pExp - cExp;
    ...
    if (pSign == cSign) {
         ...
         * starting with the significand in a DI_UINT64.
         */
...
float64 float64_muladd(float64 a, float64 b, float64 c, int flags, float_status_t *status)
{
    int aSign, bSign, cSign, zSign;
    DI_INT16 aExp, bExp, cExp, pExp, zExp;
    DI_UINT64 aSig, bSig, cSig;
    int pInf, pZero, pSign;
    DI_UINT64 pSig0, pSig1, cSig0, cSig1, zSig0, zSig1;
    int shiftcount;
    int infzero;
    int expDiff;
    ...
    cSig0 = cSig << 10;
    cSig1 = 0;
    cSig0 |= DI_CONST64(0x4000000000000000);
    expDiff = pExp - cExp;
    ...
    if (pSign == cSign) {
         ...
         * starting with the significand in a pair of DI_UINT64.
         */
        if (zSig0) {
